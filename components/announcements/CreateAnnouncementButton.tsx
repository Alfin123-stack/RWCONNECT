          ...
          <div className="bg-white w-full flex flex-col rounded-t-3xl sm:rounded-2xl max-h-[92dvh] sm:max-h-[88vh] sm:max-w-lg shadow-2xl animate-slide-up">
            ...
            <div className="overflow-y-auto flex-1 px-5 sm:px-6 py-5">
              <form
                ...
                {/* Prioritas */}
                <div>
                  <label className="label mb-2">Prioritas</label>
                    ...
                    {ANNOUNCEMENT_PRIORITIES.map((p) => {
                      ...
                      return (
                        <button
                          ...
                          <Icon
                            className={`w-4 h-4 ${active ? cfg.text : "text-slate-400"}`}
                          />
                ...
                <button
                  ...
                  <div
                    className={`w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0 transition-colors ${form.is_pinned ? "bg-amber-200" : "bg-slate-200"}`}>
                    <Pin
                      className={`w-4 h-4 ${form.is_pinned ? "text-amber-700" : "text-slate-500"}`}
                    />
                  </div>
                  ...
                  <div
                    className={`w-10 h-6 rounded-full flex-shrink-0 transition-colors relative ${form.is_pinned ? "bg-amber-400" : "bg-slate-300"}`}>
                    <span
                      className={`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-all ${form.is_pinned ? "left-5" : "left-1"}`}
                    />
                  </div>
                </button>
              </form>
